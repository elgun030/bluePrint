...
const isSelected = selectedSizes.includes(children)
  ...
  return (
    <li onClick={selectSizeHandler}
      className={`font-bold uppercase  w-9 h-9 flex items-center justify-center cursor-pointer rounded-lg ${isSelected ? 'bg-gray-900 text-white' : 'bg-gray-200 text-black'}`}
    >
      {children}
    </li>
  );
